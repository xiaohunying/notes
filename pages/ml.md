...
- [Supervised Learning - Classification Problem](#supervised-learning---classification-problem)
  ...
  - [Linear SVM (Support Vector Machine)](#linear-svm-support-vector-machine)
  - [SVM for Non-Linear Classification (Kernel)](#svm-for-non-linear-classification-kernel)
...
![equation](../resources/images/cf-linear-regression.png)

## Polynomial Regression

![equation](../resources/images/cf-polynomial-regression.png)
...
![equation](../resources/images/cf-logistic-regression.png)

## Multiclass Classification

Use **One-vs-All** (**One-vs-Rest**)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ![equation](../resources/images/cf-one-vs-all-1.gif)

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ![equation](../resources/images/cf-one-vs-all-2.gif)
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ![equation](../resources/images/cf-equation2.gif)
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ![equation](../resources/images/cf-equation3.gif)
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ![equation](../resources/images/cf-svm-for-non-linear-classification.gif)
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ![equation](../resources/images/cf-equation4.gif)
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ![equation](../resources/images/cf-equation5.gif)
...
![equation](../resources/images/cf-k-means.gif)
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ![equation](../resources/images/cf-anomaly-detection-gaussian-distribution.gif)

**Multivariate Gaussian Distribution**: 

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ![equation](../resources/images/cf-anomaly-detection-multivariate-gaussian-distribution.gif)
...
![equation](../resources/images/cf-recommender-system.gif)

**Find Related Movies**: Low related matrix factorization. Find five movies *j* with smallest

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ![equation](../resources/images/cf-recommender-system-2.gif)
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ![equation](../resources/images/cf-gradient-descent.gif)
